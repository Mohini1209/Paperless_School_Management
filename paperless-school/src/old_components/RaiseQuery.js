    ...
    componentDidMount() {
          ...
          .then(
              ...
              .then(
                  ...
                  fetch("http://localhost:8080/studentByUserId?user_id="+(sessionStorage.getItem("student_id")),{method:'post'})
          .then(response=> response.json())
        .then(
              (result) => {
               debugger
      ...
      submitQuery = () =>{
          ...
          alert("method call");
          //alert("sid - "+sessionStorage.getItem("s_id") );
          
          
            /* 

              fetch("http://localhost:8080/getonesub?subject_id="(+this.state.selectSubValue))
              .then(response=> response.json())
            .then(
                  (res) => {
                   alert(JSON.stringify(res));
...
*/
        ...
        this.setState({
          querySubmit:{
            ...
            student_id : sessionStorage.getItem("s_id")
          }
        });
let lobjQuery={qtext: questionText,subject_id: this.state.selectSubValue,student_id: sessionStorage.getItem("s_id")}
