        ...
        <div className="container-fluid">
             ...
             <div className="row">
                <div className="col-md-4">
                    <div>
                     <nav>
                            <Link to={"/studenthome/"+(this.state.student)+"/viewstudymaterial"} >View Study Material</Link><br/>
                ...
                <div className="col-md-8">
                     <Route path={"/studenthome/"+(this.state.student)+"/viewstudymaterial"} component={ViewStudyMaterial} />
