...
/*const url3="http://localhost:8080/viewAttendance?user_id"+sessionStorage.getItem("student_id")+"&month"+(this.state.selectClassValue);
             fetch(url3,{method:'post'})
             .then(res1 => res1.json())
             .then(data1 => {
                     alert(JSON.stringify(data1))
                      this.setState({at_view: data1})
